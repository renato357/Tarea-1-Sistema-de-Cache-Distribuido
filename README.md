...
El informe final del proyecto se encuentra en el directorio `report/` o en el link: https://www.overleaf.com/read/nwsqjrpkkycb#55c6e2. El cual contiene un análisis de los resultados obtenidos, comparaciones entre las diferentes configuraciones de caché, y respuestas a las preguntas planteadas en el enunciado del proyecto.
